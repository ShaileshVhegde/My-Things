...
const { addProduct, getProducts, getProductById, updateProduct, deleteProduct, getProductStats } = require('../controllers/productController');
...
router.patch('/:id', updateProduct);   // ← new update route
